...
const Info = () => {
    return (
        ...
        <div>
            <h4 className="bg-second text-primary text-h5 md:text-h3 md:text-center font-montserrat m-5 md:m-20 p-2 md:p-14 rounded-3xl">Nossa equipe é composta por profissionais experientes e 
